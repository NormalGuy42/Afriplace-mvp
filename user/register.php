                ...
                <div class="connect_options">
                    ...
                    <button type="submit" class="login_button btn-facebook">
                        <svg viewBox="0 0 200 200" aria-hidden="true" fill="currentColor"
                            ...
                            <path
                                d="M200 100a100 100 0 1 0-115.6 98.8v-69.9H59V100h25.4V78c0-25 
                                14.9-39 37.7-39 11 0 22.4 2 22.4 2v24.6H132c-12.4 0-16.3 
                                7.7-16.3 15.6V100h27.8l-4.5 29h-23.3v69.8A100 100 0 0 0 200 100"
                                stroke="none"></path>
                        </svg>
                    ...
                    <button type="submit" class="login_button btn-google">
                        <svg viewBox="0 0 48 48" preserveAspectRatio="xMinYMin meet" focusable="false"
                            ...
                            <clipPath id="g">
                                ...
                                2 11.8 2 2 11.8 2 24s9.8 22 22 22c11 0 21-8 21-22 0-1.3-.2-2.7-.5-4z">
                                </path>
                            </clipPath>
