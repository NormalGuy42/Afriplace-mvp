    ...
    <?php include('../templates/user_header.php')?>
        <div class="userpage_content">
            ...
            <div class="properties" oncontextmenu = "return false;">
                ...
                <div class="properties_container">
                <?php foreach($removedProperties as $removedProperty):?>
                    <div class="property_box" data-long="true">
                                <div class="bubble_container">
                                </div>
                                <a href="property_page.php?location=userpage.php&id=<?php echo htmlspecialchars($removedProperty['id'])?>">
                                    <div class="container">
                                        ...
                                        <img src="
                                        <?php
                                            $images = explode(',',$removedProperty['images']);
                                            echo htmlspecialchars('../'.$images[0]);
                                        ?>
                                        ">
                                    </div>
                                    <div class="outer_stats">
                                        <div class="stats_container">
                                            <div class="stat">
                                                <img src="../assets/message2.svg" alt="">
                                                <label for=""><?php echo htmlspecialchars(strval($removedProperty['messages']))?></label>
                                            </div>
                                            <div class="stat">
                                                <img src="../assets/eye.svg" alt="">
                                                <label for=""><?php echo htmlspecialchars(strval($removedProperty['views']))?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="price">
                                        <h3><span class="priceValue"><?php echo htmlspecialchars($removedProperty['price'])?></span> GNF</h3>
                                    </div>
                                    <div class="flex_container">
                                        <div class="flex">
                                            <span>
                                                ...
                                                </svg><?php echo htmlspecialchars($removedProperty['quartier'])?></span>
                                            <?php 
                                                $houses = ['Maison','Appart'];
                                                if(in_array($removedProperty['type'],$houses)):
                                            ?>
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 25">
                                                    <path d="M9.196 14.603h15.523v.027h1.995v10.64h-3.99v-4.017H9.196v4.017h-3.99V6.65h3.99v7.953zm2.109-1.968v-2.66h4.655v2.66h-4.655z" fill="#afa7a7">
                                                    </path>
                                                </svg><?php echo htmlspecialchars($removedProperty['bedNum'])?>
                                            </span>
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
                                                    <path d="M23.981 15.947H26.6v1.33a9.31 9.31 0 0 1-9.31 9.31h-2.66a9.31 9.31 0 0 1-9.31-9.31v-1.33h16.001V9.995a2.015 
                                                    2.015 0 0 0-2.016-2.015h-.67c-.61 0-1.126.407-1.29.965a2.698 2.698 0 0 1 1.356 2.342H13.3a2.7 2.7 0 0 1 1.347-2.337 
                                                    4.006 4.006 0 0 1 3.989-3.63h.67a4.675 4.675 0 0 1 4.675 4.675v5.952z" fill="#afa7a7">
                                                    </path></svg><?php echo htmlspecialchars($removedProperty['toiletteNum'])?>
                                            </span>
                                            <?php endif ?>
                                            <span>
                                                <svg width="20" height="20">
                                                    <rect y="6" height="14" width="16" fill="#afa7a7"></rect>
                                                </svg> <?php echo htmlspecialchars($removedProperty['surface'])?>m<sup>2</sup></span>
                                        </div>
                                    </div>
                                    <h4><?php echo htmlspecialchars($removedProperty['title'])?></h4>
                                    <p>
                                        <?php echo htmlspecialchars($removedProperty['description'])?>
                                    </p>
                                    <div class="btn_container">
                                        <button class="voir">Voir plus</button>
                                    </div>
