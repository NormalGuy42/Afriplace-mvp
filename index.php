    ...
    <div class="nouv">
        <section class="listings">
            ...
            <div class="listings_container">
                <?php foreach($newProperties as $property):?>
                    <div class="box">
                        <a href="viewproperty.php?id=<?php echo htmlspecialchars($property['id'])?>">
                            <div class="thumb">
                                <img src="
                                <?php
                            ...
                            <div class="info_container">
                                <h3 class="prix"><span class="priceValue"> <?php echo htmlspecialchars($property['price'])?></span> GNF</h3>
                            <div class="flex_container">
                                <div class="flex">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0, 0, 300,350">
                                            <g id="svgg">
                                                <path id="path0" d="M182.422 59.315 C 134.494 69.319,102.262 112.788,107.757 160.012 C 
                                                111.741 194.248,141.545 254.972,190.018 327.613 L 199.842 342.335 203.227 337.378 C 250.833 
                                                267.672,286.972 196.664,292.191 162.580 C 301.492 101.835,242.880 46.696,182.422 59.315 
                                                M210.156 101.591 C 247.465 109.777,261.872 155.348,235.910 183.051 C 208.562 212.232,160.123 
                                                198.586,151.861 159.375 C 144.750 125.629,176.460 94.198,210.156 101.591 " stroke="none" 
                                                fill="#afa7a7" fill-rule="evenodd"></path>
                                            </g>
                                            </svg> <?php echo htmlspecialchars($property['quartier'])?>
                                    </span>
                                    <?php if($property['type']=="Maison"|| $property['type'] =="Appart"):?>
                                        ...
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25">
                                                <path d="M23.981 15.947H26.6v1.33a9.31 9.31 0 0 1-9.31 9.31h-2.66a9.31 9.31 0 0 
                                                1-9.31-9.31v-1.33h16.001V9.995a2.015 2.015 0 0 0-2.016-2.015h-.67c-.61 
                                                0-1.126.407-1.29.965a2.698 2.698 0 0 1 1.356 2.342H13.3a2.7 2.7 0 0 1 1.347-2.337 
                                                4.006 4.006 0 0 1 3.989-3.63h.67a4.675 4.675 0 0 1 4.675 4.675v5.952z" fill="#afa7a7"/>
                                            </svg> <?php echo htmlspecialchars($property['toiletteNum'])?>
                                        </span>
                                    <?php endif?>
                                    <span>
                                        <svg width="20" height="20"><rect y="6"height="14" width="16" fill="#afa7a7"></rect>
                                        </svg> <?php echo htmlspecialchars($property['surface'])?>m<sup>2</sup>
                                    </span>
                                </div>
                            </div>
                            <div class="text">
                            ...
                            <div class="btn">
                                <a href="viewproperty.php?id=<?php echo htmlspecialchars($property['id'])?>" class="btn">voir le bien</a>
                            </div>
                    </div>                
                <?php endforeach?>
            </div>
