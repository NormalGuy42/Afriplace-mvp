    ...
    <div class="nav">
        <section class="navigation">
            ...
            <div class="navigation_container">
                <a href="searchpage.php" style="text-decoration: none;">
                    <div class="box">
    ...
    <section class="newsletter">
        ...
        <form action="get">
            <div class="box">
                ...
                <div class="subbox">
                    <input type="email" class="mailbox" placeholder="Votre email" maxlength="30">
                    <button class="sub">Inscrivez-moi</button>
                </div>
            </div>
        </form>
    </section>
            ...
            <div class="thumb">
                ...
                <div class="caption_container">
                    <div class="caption">
                        ...
                        <button><a href="searchpage.php">Explorez</a></button>
                    </div>
                </div>
